# new_project/src/agents/fundamentals.py
...
class FundamentalAnalyzer:
    ...
    def _analyze_profitability(self, metrics) -> dict:
        ...
        if score >= 2:
            ...
            signal = "neutral"
        details = ((f"ROE: {roe:.2%}" if roe is not None else "ROE: N/A") + ", " +
    ...
    def analyze_financials(self, ticker: str, end_date: str) -> Optional[AgentStateData]:
        ...
        signals = [profitability["signal"], growth["signal"], health["signal"], valuation["signal"]]
